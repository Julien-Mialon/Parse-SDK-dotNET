    ...
    public string AppName {
      get {
        var task = Package.Current.InstalledLocation.GetFileAsync("AppxManifest.xml").AsTask().OnSuccess(t => {
          ...
          var propertiesXName = XName.Get("Properties", "http://schemas.microsoft.com/appx/manifest/foundation/windows10");
          var displayNameXName = XName.Get("DisplayName", "http://schemas.microsoft.com/appx/manifest/foundation/windows10");
